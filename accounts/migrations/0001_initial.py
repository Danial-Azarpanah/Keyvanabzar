    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('message', models.TextField(max_length=100, verbose_name='پیغام')),
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='تاریخ ارسال پیام در')),
            ],
            options={
                'verbose_name': 'پیام',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telephone', models.CharField(max_length=11, verbose_name='شماره تلفن ثابت')),
                ('email', models.EmailField(max_length=254, verbose_name='ایمیل')),
